...
## Follow-up: every-gun clearance audit

Checked the three base guns plus all 16 Gun Game firearms, including all sniper variants. The browser test now measures projected mesh vertices at 1440×900 and 800×600 in hip fire and ADS, at zero/half/full recoil and minimum/zero/maximum sway: 684 combinations. All non-sniper model vertices must remain at least 4% of viewport height below the reticle; sniper ADS must hide the viewmodel. Street Sweeper and Quad Barrel needed more recoil clearance, and Ranger needed more clearance at maximum upward sway. Lowered shotgun holds by another 0.06 world units and rifle-family holds by 0.02. All 684 checks and the production build pass. Contact sheets for both sizes were visually reviewed, covering every gun individually. Sniper poses are unchanged.
